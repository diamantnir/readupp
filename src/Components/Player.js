...
<div class="mobileMenu" id="mobileMenu">
        <div class="inner">
            ...
            <ul>
                ...
                <li><a onClick={() => Contacts()}>Contact us</a></li>
                <li><a onClick={() => Help()}>Help</a></li>
                <li><a onClick={() => Copyrights()}>Copyrights</a></li>
                <li><a href="#">accessibility tatement</a></li>
		...
		<div class="modal-dialog preference_modal">
			<div class="modal-content">
				<div class="container-fluid">
					<div class="d-flex align-items-start py-3 px-0 px-md-3" syle={{'margin-top':'30px'}}>
