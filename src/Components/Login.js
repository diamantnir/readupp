        ...
        <div>
          ...
          <details className="custom-select">
            <summary className="radios">
              <input type="radio" name="item" id="default" title="English" defaultChecked />
              <input type="radio" name="item" id="עברית" title="עברית" onClick={hebrew}/>
              <input type="radio" name="item" id="English" title="English"  onClick={english}/>
            </summary>
            <ul className="list">
              <li>
      ...
      <div className="login_form_inputs mt-5">
        <div className="container-fluid">
          <div className="row gy-2">
            ...
            <div className="col-12 " style={{'margin-top':'0px !important'}}>
              <hr style={{'margin':'0px'}}/>
              <div className="d-flex gap-1 justify-content-center">
                <p className="color11 mb-0 f14">{translate!=null?translate[5].value:'Dont have an account?'}</p>
                <a className="color1 fw800 f14 register" href="/register">{translate!=null?translate[6].value:'Register'}</a>
              </div>
            </div>
          </div>
        </div>
